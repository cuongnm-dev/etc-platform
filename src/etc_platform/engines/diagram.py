...
log = logging.getLogger("etc-platform.diagram")
...
def _render_svg_template(template_name: str, data: dict) -> str:
    ...
    Example: _render_svg_template("kien-truc-4-lop", {...}) →
        loads src/etc_platform/templates/diagrams/svg/kien-truc-4-lop.svg.j2
    """
...
def _render_mermaid(
    ...
    from etc_platform.tools.render_mermaid import render_one
